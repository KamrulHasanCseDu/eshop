  ...
  */
   ...
   include 'business_layer.php'; 
    ...
    if(array_key_exists('customer_name',$_SESSION) && !empty($_SESSION['customer_name'])){ 
        ...
        $log_status = "sign in";
    /*
     * check how the product will show:
     * according to price,
     * according to brand
					...
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
                                                        <li><a href="homepage.php"style="background-color:#041a33;margin-top: 20px;"><font color="whitesmoke" size="4.5px">Home</font></a></li>
                                                        <li>
                                                           <?php 
						...
						<div class="col-sm-4">
							<div class="product-image-wrapper">
								<div class="single-products">
                                                                    <div class="productinfo text-center"><br><br>
                                                                                   <?php
