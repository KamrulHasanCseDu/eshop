 ...
 *our used variable:
 * $i,$j for loop
 * $x for customer log in info
 */
    session_start();
 
    include 'business_layer.php'; 
    $db=new business_layer(); //create object for business layer
    
   
    $number_of_product = $db->get_number_of_product();//how many number is in my product table
    ...
    /*
     * if customer wants to be kept himself logged in 
     */
    ...
    $x="some"; // check this variable only
...
<body
    ...
    <header id="header" >			
		<div class="header-top" style="background-color:#041a33">
			<div class="container">
				<div class="row">
					<div class="col-sm-4">
		...
		<div class="header-middle" style="background-color:#041a33"><!--header-middle-->
			<div class="container">
				<div class="row">
					<div class="col-sm-10">	   
									...
									<h2><?php echo $xml_off->product[$i]->product_name; ?></h2>
                                                                        ...
                                                                        <br> <?php //echo $xml->product[$i]->product_name;
                                                                                    ...
                                                                                    if($log_status != 'sign in'){
                                                                                         ?>
                                                                                            <br><a href="index.php?id= <?php echo $id;?> ">Rate it</a>
                                                                                     <?php
                                                                                       }
                                                                                       ?>
                                                                </div>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm-3">
						...
						<h2>Category</h2>
						<div class="panel-group category-products" id="accordian" style="background-color:#041a33;"><!--category-productsr-->
							<div class="panel panel-default" style="background-color:#041a33" >
								<div class="panel-heading">
                                                                    <h4 class="panel-title"><a href="OtherPage.php?name=laptop" style="background-color:#041a33; font-size:25px" ><font color="whitesmoke">laptop</font></a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
                                                                    <h4 class="panel-title"><a href="OtherPage.php?name=notebook" style="background-color:#041a33; font-size:25px" ><font color="whitesmoke">notebook</font></a></h4>
								</div>
							</div>
							<div class="panel panel-default">
								<div class="panel-heading">
                                                                    <h4 class="panel-title"><a href="OtherPage.php?name=tv" style="background-color:#041a33; font-size:25px"><font color="whitesmoke">television</font></a></h4>
								</div>
							</div>
							
							<div class="panel panel-default">
								<div class="panel-heading">
                                                                    <h4 class="panel-title"><a href="OtherPage.php?name=desktop" style="background-color:#041a33; font-size:25px"><font color="whitesmoke">Desktop</font></a></h4>
								</div>
							</div>
							...
							<h2>Brands</h2>
                                                        <div class="brands-name" style="background-color:#041a33" >
								<ul class="nav nav-pills nav-stacked">
                                                                    <li><a href="OtherPage.php?name=hp" style="background-color:#041a33; font-size:25px" > <span class="pull-right"></span><font color="whitesmoke">hp</font></a></li>
                                                                    <li><a href="OtherPage.php?name=dell" style="background-color:#041a33;font-size:25px"> <span class="pull-right"></span><font color="whitesmoke">dell</font></a></li>
                                                                    <li><a href="OtherPage.php?name=apple" style="background-color:#041a33;font-size:25px"> <span class="pull-right"></span><font color="whitesmoke">apple</font></a></li>
                                                                    <li><a href="OtherPage.php?name=toshiba" style="background-color:#041a33;font-size:25px"> <span class="pull-right"></span><font color="whitesmoke">toshiba</font></a></li>
                                                                    <li><a href="OtherPage.php?name=samsung" style="background-color:#041a33;font-size:25px"> <span class="pull-right"></span><font color="whitesmoke">samsung</font></a></li>
                                                                    <li><a href="OtherPage.php?name=asus" style="background-color:#041a33;font-size:25px"> <span class="pull-right"></span><font color="whitesmoke">asus</font></a></li>
                                                                    <li><a href="OtherPage.php?name=walton" style="background-color:#041a33;font-size:25px"> <span class="pull-right"></span><font color="whitesmoke">walton</font></a></li>
								</ul>
							</div>
						</div><!--/brands_products-->
